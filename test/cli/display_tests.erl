...
displays_an_empty_board_test() ->
  ...
  {ok, Output}          = test_io:redirect_io("", fun() -> update(Game) end),
  true = contains(Output, " 1 | 2 | 3 \n"
                          "---+---+---\n"
                          " 4 | 5 | 6 \n"
                          "---+---+---\n"
                          " 7 | 8 | 9 \n").
...
contains(String, SubString) ->
  strings:contains(strings:remove_colors(String), SubString).
